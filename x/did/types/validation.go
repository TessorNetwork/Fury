...
func (v *VerificationMethod) Validate(subject string) error {
	...
	// fury: same as the subject i.e. the ID field of DID document
	...
	// fury: keys of type RsaVerificationKey2018 must be with suffix #keys-1, and must be a valid RSA PKIX public key
	...
	// fury: keys of type RsaSignatureKey2018 must be with suffix #keys-2, and must be a valid RSA PKIX public key
