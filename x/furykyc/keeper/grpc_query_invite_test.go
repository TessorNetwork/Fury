...
func (suite *KeeperTestSuite) TestGRPCInvites() {
	...
	app.FuryKycKeeper.AssignMembership(ctx, testUser, types.MembershipTypeGold, testTsp, testExpiration)
	app.FuryKycKeeper.SetInvite(ctx, testInviteSender, testUser)
	app.FuryKycKeeper.SetInvite(ctx, testUser3, testUser)
