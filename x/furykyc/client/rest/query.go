...
func RegisterRoutes(cliCtx client.Context, r *mux.Router) {
	r.HandleFunc("/furykyc/funds", getPoolFunds(cliCtx)).Methods("GET")
	r.HandleFunc(fmt.Sprintf("/tessornetwork/furykyc/invite/{%s}", restParamAddress),
		getInviteHandler(cliCtx)).Methods("GET")
	r.HandleFunc("/furykyc/invites", getInvitesHandler(cliCtx)).Methods("GET")
	r.HandleFunc("/furykyc/tsps", getTrustedServiceProvidersHandler(cliCtx)).Methods("GET")
	r.HandleFunc("/furykyc/memberships", getMemberships(cliCtx)).Methods("GET")
	r.HandleFunc(fmt.Sprintf("/furykyc/membership/{%s}", restParamAddress),
		getMembershipForAddr(cliCtx)).Methods("GET")
	r.HandleFunc(fmt.Sprintf("/furykyc/sold/{%s}", restParamTsp),
