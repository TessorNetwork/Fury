...
import (
	...
	commgenutilcli "github.com/tessornetwork/fury/x/genutil/client/cli"
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customTemplate, customFuryConfig := initAppConfig()
			//return server.InterceptConfigsPreRunHandler(cmd)
			return server.InterceptConfigsPreRunHandler(cmd, customTemplate, customFuryConfig)
		},
	}
...
func initAppConfig() (string, interface{}) {
	...
	FuryAppCfg := CustomAppConfig{Config: *srvCfg}

	FuryAppTemplate := serverconfig.DefaultConfigTemplate

	return FuryAppTemplate, FuryAppCfg
}
