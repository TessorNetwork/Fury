...
func RegisterRoutes(cliCtx client.Context, r *mux.Router) {
	r.HandleFunc(
		fmt.Sprintf("/furymint/{%s}/etp", restuser),
		getEtpsHandler(cliCtx)).Methods("GET")
	r.HandleFunc(
		fmt.Sprintf("/furymint/{%s}/etpsOwner", restuser),
		getEtpsByOwnerHandler(cliCtx)).Methods("GET")
	r.HandleFunc("/furymint/etps", getAllEtpsHandler(cliCtx)).Methods("GET")
	r.HandleFunc("/furymint/params", getParamsHandler(cliCtx)).Methods("GET")
}
