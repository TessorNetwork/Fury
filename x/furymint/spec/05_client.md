...
```
tessornetwork.fury.furymint.Query/Etps
```
...
```
tessornetwork.fury.furymint.Query/EtpsByOwner
```
...
```
tessornetwork.fury.furymint.Query/Etp
```
...
```
tessornetwork.fury.furymint.Query/Params
```
