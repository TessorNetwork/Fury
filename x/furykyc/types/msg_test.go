...
func TestMsgInviteUser_UnmarshalJson(t *testing.T) {
	//json := `{"type":"fury/MsgInviteUser","value":{"recipient":"cosmos1lwmppctrr6ssnrmuyzu554dzf50apkfvd53jx0","sender":"cosmos1lwmppctrr6ssnrmuyzu554dzf50apkfvd53jx0"}}`
...
func TestMsgDepositIntoLiquidityPool_UnmarshalJson(t *testing.T) {
	//json := `{"type":"fury/MsgDepositIntoLiquidityPool","value":{"depositor":"cosmos1lwmppctrr6ssnrmuyzu554dzf50apkfvd53jx0","amount":[{"denom":"uatom","amount":"100"}]}}`
...
func TestMsgAddTsp_UnmarshalJson(t *testing.T) {
	//json := `{"type":"fury/MsgAddTsp","value":{"government":"cosmos1ct4ym78j7ksv9weyua4mzlksgwc9qq7q3wvhqg","tsp":"cosmos152eg5tmgsu65mcytrln4jk5pld7qd4us5pqdee"}}`
...
func TestMsgRemoveTsp_UnmarshalJson(t *testing.T) {
	//json := `{"type":"fury/MsgRemoveTsp","value":{"government":"cosmos1ct4ym78j7ksv9weyua4mzlksgwc9qq7q3wvhqg","tsp":"cosmos152eg5tmgsu65mcytrln4jk5pld7qd4us5pqdee"}}`
	json := `{"government":"cosmos1ct4ym78j7ksv9weyua4mzlksgwc9qq7q3wvhqg","tsp":"cosmos152eg5tmgsu65mcytrln4jk5pld7qd4us5pqdee"}`
...
func TestMsgBuyMembership_GetSignBytes(t *testing.T) {
	//expected := `{"type":"fury/MsgBuyMembership","value":{"buyer":"cosmos1lwmppctrr6ssnrmuyzu554dzf50apkfvd53jx0","membership_type":"bronze","tsp":"cosmos152eg5tmgsu65mcytrln4jk5pld7qd4us5pqdee"}}`
...
func TestNewMsgSetMembership_GetSignBytes(t *testing.T) {
	//expected := `{"type":"fury/MsgSetMembership","value":{"government":"cosmos1ct4ym78j7ksv9weyua4mzlksgwc9qq7q3wvhqg","new_membership":"black","subscriber":"cosmos1lwmppctrr6ssnrmuyzu554dzf50apkfvd53jx0"}}`
...
func TestNewMsgRemoveMembership_GetSignBytes(t *testing.T) {
	//expected := `{"type":"fury/MsgRemoveMembership","value":{"government":"cosmos1ct4ym78j7ksv9weyua4mzlksgwc9qq7q3wvhqg","subscriber":"cosmos152eg5tmgsu65mcytrln4jk5pld7qd4us5pqdee"}}`
